...
/** Sample call for ListFinancialEventGroups. */
public class ListFinancialEventGroupsSample {
     ...
     * @return The response.
     */
    public static ListFinancialEventGroupsResponse invokeListFinancialEventGroups(
