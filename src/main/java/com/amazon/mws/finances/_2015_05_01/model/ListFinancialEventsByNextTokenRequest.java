...
/**
 * ListFinancialEventsByNextTokenRequest complex type.
 *
 * XML schema:
 *
 * <pre>
 * &lt;complexType name="ListFinancialEventsByNextTokenRequest"&gt;
 *    &lt;complexContent&gt;
 ...
 * </pre>
 */
public class ListFinancialEventsByNextTokenRequest extends AbstractMwsObject {
    ...
    public void writeTo(MwsWriter w) {
        w.write("http://mws.amazonservices.com/Finances/2015-05-01", "ListFinancialEventsByNextTokenRequest",this);
    }

    /** Value constructor. */
    public ListFinancialEventsByNextTokenRequest(String sellerId,String mwsAuthToken,String nextToken) {
        this.sellerId = sellerId;
        this.mwsAuthToken = mwsAuthToken;
        this.nextToken = nextToken;
    }    
    ...
    public ListFinancialEventsByNextTokenRequest(String sellerId,String nextToken) {
        this.sellerId = sellerId;
        this.nextToken = nextToken;
    }
    ...
    /** Default constructor. */
    public ListFinancialEventsByNextTokenRequest() {
        super();
    }
